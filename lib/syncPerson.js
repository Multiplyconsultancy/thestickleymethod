...
/* `stalled` no longer emits a tag: customer-never-paid was noise, and the
   absence of has-tsm already says the same thing. */
const SEG = { paying: 'customer-active', churned: 'customer-churned', stalled: null }
const LTV = {
...
const PLAN_FROM_TITLE = [
  ...
  /* coaching retired */ [/^the stickley method\s*$/i, 'plan-1-month'],
]
